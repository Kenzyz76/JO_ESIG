...
#Création d'une interface pour demandé une entrée à l'utilisateur et la récupérer
def récup_entree():
    resultat=f_ENTREE.get()
    return(ENTREE)

f_ENTREE = tk.Entry(fenetre, width=40)
f_ENTREE.pack(pady=20)

creer_bouton(fenetre,)
...
def afficher_interface_athlete():
    ...
    creer_bouton(cadre_gauche, "Afficher par pays", afficher_athlete, 20, 2,'#6ecaf2','Tw Cen MT',12)
